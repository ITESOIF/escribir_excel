...
suppressMessages(require(readxl)) #Leer Excel
...
IAK <- read_excel("~/GitHub/escribir_excel/iShares-US-Insurance-ETF_fund.xlsx", 
                  col_names = TRUE, sheet = "Holdings")
...
# Obteniendo datos de las acciones del ETF que si estan e QUANDL
for(i in 1:length(tk)){
...
```{r,eval=TRUE, include=TRUE, echo=TRUE, prompt=FALSE}
#Cambiar la longitud de esto con los tk nuevos no solo 3
